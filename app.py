    ...
    if st.button("Forecast", key="forecast_pricing_button"):
        ...
        for i, scenario in enumerate(st.session_state.selected_scenarios):
            ...
            with cols[i]:
                ...
                st.markdown(f"""
                    <div style="margin: 10px; padding: 10px; background-color: #0F67B1; border-radius: 20px; color: white; text-align: center; width: 120px; height: 70px; display: flex; align-items: center; justify-content: center;">
